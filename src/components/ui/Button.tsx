...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'outline' | 'ghost' | 'pride' | 'danger';
  size?: 'sm' | 'md' | 'lg';
  isLoading?: boolean;
}
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const base = 'inline-flex items-center justify-center font-medium rounded-xl transition-all focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none active:scale-98 cursor-pointer select-none';
  ...
  const variants = {
    ...
    pride: 'bg-gradient-to-r from-rose-500 via-pink-500 to-indigo-600 hover:opacity-95 text-white shadow-md shadow-rose-500/20 font-bold',
